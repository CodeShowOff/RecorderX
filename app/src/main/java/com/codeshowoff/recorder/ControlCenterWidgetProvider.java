...
public class ControlCenterWidgetProvider extends AppWidgetProvider {
    ...
    public static final String ACTION_WIDGET_UPDATE = "com.codeshowoff.recorder.ACTION_WIDGET_UPDATE";
    public static final String ACTION_TOGGLE_BUBBLE = "com.codeshowoff.recorder.ACTION_TOGGLE_BUBBLE";
    public static final String ACTION_TOGGLE_CAM = "com.codeshowoff.recorder.ACTION_TOGGLE_CAM";
    public static final String ACTION_TOGGLE_ORIENT = "com.codeshowoff.recorder.ACTION_TOGGLE_ORIENT";
    public static final String ACTION_TOGGLE_AUDIO = "com.codeshowoff.recorder.ACTION_TOGGLE_AUDIO";
